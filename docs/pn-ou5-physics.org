...
*** Corradi abundance table
Ou 5

11.30 ÷ 0.05 7.46 ÷ 0.05 8.18 $ 0.06 7.70 +0.08 -0.06 6.69 ÷ 0.08 6.15 ÷ 0.05 5.02 -0.15 -0.20 Correcteda

11.29 $ 0.05 7.58 ÷ 0.05 8.40 0.05 7.96 ÷ 0.05 6.81 $ 0.07 6.29 $ 0.05 5.20 -0.10 -0.20
...
| Element | Abundance.      | Corrected        |
|---------+-----------------+------------------|
| He      | 11.30 ÷ 0.05    | 11.29 $ 0.05     |
| N       | 7.46 ≤ 0.05     | 7.58 ÷ 0.05      |
| O       | 8.18 ÷ 0.06     | 8.40 ÷ 0.05      |
| Ne      | 7.70 +0.08-0.06 | 7.96 ÷ 0.05      |
| S       | 6.69 ÷ 0.08     | 6.81 $ 0.07      |
| Ar      | 6.15 $ 0.05     | 6.29 ÷ 0.05      |
| Cl      | 5.02 +0.20      | 5.20 +0.17 -0.20 |
|         |                 |                  |
*** Carbon abundance
...
*** Repeat for the new abundance set
...
#+RESULTS:
| He-II-FLUXES                           | Wav      | log10(F) | 4651/Hb |
...
- We successfully bracket the observed value of 0.71
- Interestingly, the variation is reversed with respect to the fixed n=140 case
  - The high metallicity variation models have higher 4686/Hb 
#+begin_src bash :dir ../cloudy :results output table
  echo "He-II-FLUXES Wav log10(F) 4686/Hb"
  for f in $(ls ou5a-T115-L660-n-lha*.out); do
      printf "$f "; grep "4685.68A" $f |tail -1 | cut -c20-48
...
| ou5a-T115-L660-n-lha-Z30fluct-long.out  | 4685.68A |   32.979 |  1.1486 |
| ou5a-T115-L660-n-lha-Z30fluct-short.out | 4685.68A |   32.934 |  1.2193 |
