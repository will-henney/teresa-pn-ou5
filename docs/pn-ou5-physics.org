...
* Instrumental widths
| Line  |    lam | d lam |   d v | sigma |
|-------+--------+-------+-------+-------|
| Ha    | 6562.8 |  0.26 | 11.89 |       |
| o iii | 5006.8 |  0.19 | 11.38 |       |
#+TBLFM: $4=3e5 $3 / $2 ; f2
...
** Summary of sizes, velocities, and ages
...
#+TBLFM: $4=0.0194 sqrt(vmeane($2)**2 + vmeane($3)**2);f2::$6=sin($5 + 85 +/- 1);f3::$8=$-1/2 $-2;f0::$9=9.778e1 $4 / $8;f1::$5=vmin($2) == 0 ? 90 : arctan(vmeane($3) / vmin($2));f0


** Transposed summary table of components
