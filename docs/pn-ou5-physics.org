...
- Dynamic time
  - t / yr = R / V = (R/arcsec) 0.0194 pc / (V/km/s) km yr = 1.90e4 (R/arcsec) / V


| Component   | (r_1, r_2)    | (Z_1, Z_2) | mean R         | Splitting |      V_exp | t_din              |
|-------------+-------------+----------+----------------+-----------+-----------+-------------------|
| Inner lobes | [4.3, 8.8]  | [0, 8]   | 7.67 +/- 2.83  |        26 |        13 | 1.12e4 +/- 4.14e3 |
| Outer lobes | [8.5, 11.3] | [8, 15]  | 15.17 +/- 2.81 |        37 |        20 | 1.44e4 +/- 2.67e3 |
| Outermost   | [15, 18]    | [0, 3]   | 16.57 +/- 1.50 |        70 |        35 | 9.00e3 +/- 8.14e2 |
| Polar Knots | [0, 4]      | [21, 29] | 25.08 +/- 3.99 |         7 | 33 +/- 11 | 1.44e4 +/- 5.33e3 |
#+TBLFM: $4=sqrt(vmeane($2)**2 + vmeane($3)**2);f2::$7=1.90e4 $4 / $6;s3
