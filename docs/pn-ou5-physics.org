* DONE Tasks remaining for the paper
CLOSED: [2025-12-09 Tue 13:13]
:LOGBOOK:
...
** DONE Physical params
CLOSED: [2025-12-09 Tue 13:13]
:LOGBOOK:
- Note taken on [2025-12-09 Tue 13:12] \\
  Mark all these as done
:END:
- [X] Q5. Put Ou 5’s ionized mass in context of PN population; test the “very low-mass” claim.
- [X] Q13. Retrieve Bertolami tracks to find initial mass giving evolutionary age consistent with the kinematic age.
- [X] Q12. Contrast Ou 5’s relatively simple kinematics with NGC 6210 (Turtle): multiple ejections (~5 axes) over ~5000 yr → diversity of PNe.
- [X] Q18. Discuss implications of your higher L and T_{\mathrm{eff}} for the central star: contrary to Jones et al. post-RGB inference, your values favor a post-AGB status.
- [X] Q19. Check N/O and C/O for enrichment signatures.
- [X] Q20. Explore processes that could raise overall metallicity while keeping C/O and N/O near solar.
...
- But supposedly, it is 11.76 km/s at Ha
  - which would give
    ...
    - [ ] 
    - 
** Try again at determining instrumental width
From the observing manual:
: La escala de placa del f/7.5 es de 13.1 arcsec/mm. Para el caso del
: CCD SITE 3, con píxeles cuadrados de 24 micras, esto
: corresponde a .301 arcsec/píxel. Por lo tanto, para el caso de
: binning x 2, la escala es de .602 arcsec/píxel.

And

: La rendija de 150 micras se proyecta en ~ 120 micras ≡ 6 pixeles
: de 24 micras, i.e. en caso de binning 2 x 2 implica 3 píxeles.
: La rendija de 70 micras se proyecta en ~ 60 micras ≡ 3 píxeles de
: 24 micras (e.g. SITE 3). Para binning 2 x 2 implica 2 pixeles.
: Notar que la cámara resuelve la imagen de la rendija de 150
: micras, por lo que los perfiles de las líneas de la lámpara de Th Ar
: parecen cuadrados, más que gaussianos.

- We are using the CCD E2V-4240, which has pixels of 0.176845 arcsec, which means 1000 (0.176845 / 13.1) = 13.5 microns
- This means that the projected slit width in pixels is
  - 70 micron slit: 60 / 13.5 = 4.44 pixels
  - 150 micron slit: 120 / 13.5 = 8.89 pixels
- For Ha we have unbinned pixel width of 1.23 to 1.29 km/s (from FITS headers)
  - 70 micron: 4.44 [1.23 .. 1.29] = [5.5 .. 5.7] km/s
  - 150 micron: 8.89 [1.23 .. 1.29] = [10.9 .. 11.5]
- For [O III] we have unbinned pixel width 1.29 to 1.30 km/s
  - 70 micron: 4.44 [1.29 .. 1.30] = [5.7 .. 5.8] km/s
  - 150 micron: 8.89 [1.29 .. 1.30] = [11.5 .. 11.6] km/s
...
- Stellar radius from Stefan Boltzmann
  ...
  - Using 480 +/- 180 we get
    - R = sqrt(480 +/- 180) / (103 +/- 4 / 5.578)**2 = 0.0643 +/- 0.0130
...
- Optical depth of Lyman continuum from [[id:B9698DFD-3E25-41CF-B77E-893B44846D71][H beta gives fraction of H-ionizing photons absorbed]]
  - \eta = 0.198 \pm 0.002
  - So \tau = -ln(\eta) = 1.62 +/- 0.01
** Zanstra analysis of Gruenwald:2000a
- This is the same, but uses T_Z(He II) and He II 4686 / He I 5876
- See their Fig 4
- Observed ratio  4686 / 5876 = 71.11 / 20.12 = 3.5343
  - log(4686 / 5876) = 0.5483
- This shows we are in the regime where T_z(He II) is a good measure of T_*
- And that \tau(13.6) is a bit more than 1
  - Which is consistent with what we derived above. 
...
- Orbital speed:
  ...
  - 
** New binary orbit with higher primary mass
- Evolutionary tracks give M_1 = 0.58 \pm 0.01
- Correlations in the posteriors in the Jones fitting give
  - M_2 = 0.32 (40% higher)
  - R_2 = 0.60 (7% higher)
- Period stays the same at P = 0.364 d
- This yields
  - Semi-major axis: a = 2.072 R_sun
  - R_2 / a = 0.60 / 2.072 = 0.2896
  - Secondary Roche lobe: 0.681 R_sun
  - Secondary underfills its Roche lobe by 12%
    - or volume filling fraction (0.60 / 0.681)**3 = 0.68
- R_1 = 0.075 R_sun from our models = 0.125 R_2
  - So ramps at start/end of eclipse should be about 1/8 of duration
** Binary orbit from the Sergey model
- Primary
  - M_1 = 0.58 (Msun)
  - R_1 = 0.0768 (Rsun)
  - T_1 = 115000.00
...
- Secondary
  ...
  - T_2 = 5250.00 K
  - R_2 = 0.841 (X), 0.616 (Y)
  - spherical equivalent: (0.841 0.616 0.616)**(1/3) = 0.683
- Orbit
  - q = 0.56
  - a = 0.74 + 1.33 = 2.07 Rsun
  - R_Roche(secondary) = 0.685 (Rsun)
  - 
*** Details of the Sergey model
- From Kara:2025a we find citations for the modelling:
  - Zharikov:2013a 2013A&A...549A..77Z
    - Brief description, but not much detail at all
  - Subebekova:2020a 2020MNRAS.497.1475S
    : We used gathered photometric observations to analyse eclipse
    : light curves using a tool developed by Zharikov et al. (2013)
    : to improve the system’s definition. Briefly, the model includes a
    : primary WD, a secondary red dwarf star, a stream of accretion
    : matter, thick h(r)= h(rout)(r/rout)γ (γ= 1) accretion disc, and an
    : extended hotspot/line. The WD is a sphere, defined by the mass–
    : radii relation in (2.83b Warner 1995). The secondary is assumed to
    : fill its Roche lobe, and the Roche lobe shape is directly calculated
    : using equation (2.2 Warner 1995) for equipotential (L1). The
    : surface of each component of the system is divided into a series
    : of triangles. We assume that each triangle emits as a blackbody
    : with the corresponding temperature. The limb darkening (Claret,
    : Hauschildt & Witte 2012) and the illumination of the secondary by
    : the primary are also included. Each element’s intensity is convolved
    : with the corresponding filter bandpass and converted into the flux
    : taking into account the element surface, orientation, distance to the
    : system, and interstellar absorption. The light curves of individual
    : components and the binary system as a whole were obtained by
    : integrating the emission from all the elements lying in view. Details of
    : the light-curve modelling of similar NLs are described in Tovmassian
    : et al. (2014) and Hernandez et al. (2017).
    - So this shows that they assume BB emission everywhere
  - Kara:2021a
    - Not much more detail
  - Kara:2023a
    - Again, not much more detail that is any use to us
    - The main focus of the models is on the accretion disk and the hotspot
